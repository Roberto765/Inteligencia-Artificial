...
urlInicial = r"F:\9-Semestre\Inteligencia Artificial\Codigos\Proyecto2\pygamesc\pygamesc"
...
# Cargar imágenes
jugador_frames = [
    pygame.image.load(os.path.join(urlInicial, 'assets', 'sprites', 'mono_frame_1.png')),
    pygame.image.load(os.path.join(urlInicial, 'assets', 'sprites', 'mono_frame_2.png')),
    pygame.image.load(os.path.join(urlInicial, 'assets', 'sprites', 'mono_frame_3.png')),
    pygame.image.load(os.path.join(urlInicial, 'assets', 'sprites', 'mono_frame_4.png'))

]
bala_img = pygame.image.load(os.path.join(urlInicial, 'assets', 'sprites', 'purple_ball.png'))
fondo_img = pygame.image.load(os.path.join(urlInicial, 'assets', 'game', 'fondo2.png'))
nave_img = pygame.image.load(os.path.join(urlInicial, 'assets', 'game', 'ufo.png'))
menu_img = pygame.image.load(os.path.join(urlInicial, 'assets', 'game', 'menu.png'))
...
def entrenar_modelos():
    ...
    modelo_red_neuronal = MLPClassifier(hidden_layer_sizes=(50, 50), max_iter=10000)
...
def limpiar_datos_modelo():
    ...
    print("Modelos y dataset eliminados. Creando nuevos datos...")
...
def mostrar_menu():
    ...
    pantalla.fill(NEGRO)
    texto = fuente.render("Presiona 'A' para Automatico, 'M' para Manual, o 'Q' para Salir", True, BLANCO)
...
def mostrar_menu_automatico():
    ...
    pantalla.fill(NEGRO)
    opciones = ["1 - Arbol decision", "2 - Redes Neuronales", "3 - Vecinos", "4 - Volver"]
    ...
    while correr:
        for evento in pygame.event.get():
            ...
            if evento.type == pygame.KEYDOWN:
                ...
                if evento.key == pygame.K_UP and en_suelo and not pausa and not modo_auto:
                    salto = True
                    en_suelo = False
